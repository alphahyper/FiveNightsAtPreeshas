...
public class HUDManager : MonoBehaviour
{
    ...
    public static void ShowOfficeHUD()
    {
        clock.enabled = true;
        power.enabled = true;
        GameObject.Find("HUD").transform.Find("NormalHUD").transform.Find("UsageText").gameObject.SetActive(true);
    }
    ...
    public static void HideOfficeHUD()
    {
        clock.enabled = false;
        power.enabled = false;
        GameObject.Find("HUD").transform.Find("NormalHUD").transform.Find("UsageText").gameObject.SetActive(false);
    }
}
